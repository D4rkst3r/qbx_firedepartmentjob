    ...
    for _, player in pairs(players) do
        ...
        if IsFirefighter(job) then
            ...
            result[#result + 1] = {
                ...
                onDuty     = exports.qbx_firedepartmentjob:IsPlayerOnDuty(player.PlayerData.source),
            }
        end
    end
    return result
...
RegisterNetEvent('qbx_firedepartmentjob:server:AdminSetDuty', function(targetId, duty)
    ...
    exports.qbx_firedepartmentjob:SetPlayerDuty(targetId, duty)
...
RegisterNetEvent('qbx_firedepartmentjob:server:AdminKickFromDuty', function(targetId)
    ...
    exports.qbx_firedepartmentjob:SetPlayerDuty(targetId, false)
    TriggerClientEvent('ox_lib:notify', targetId, {
